...
\end{figure*}
 ...
 The resolution of $\delta$ measurement as a function of the detector mass is shown in Fig. \ref{fig:del_delres_mdet} (only neutrino exposition)
and Fig. \ref{fig:del_delres_mdet_anu} (antineutrino exposition is used). The project detector mass is 8 mt.
...
and energy resolutions 0.3 (nominal value, upper curve) and 0.05 (lower curve). Total exposition 3 years, neutrino only.
...
\begin{figure*}[h]
\begin{center}
\includegraphics[width=0.75\textwidth]{del_delres_mdet_anu.pdf}
\caption {Resolution of the $\delta$ CP measurement as a function of the detector mass for the true value $\delta = \pi/2$
and energy resolutions 0.3 (nominal value, upper curve) and 0.05 (lower curve). Total exposition 3 years, antineutrino exposition is used.
\label{fig:del_delres_mdet_anu}}
\end{center}
\end{figure*}
