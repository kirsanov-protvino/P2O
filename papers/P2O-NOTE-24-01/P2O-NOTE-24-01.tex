...
\end{figure*}
 ...
 The resolution of $\delta$ measurement for the true value $\delta = 3\pi/2$ is shown in Fig. \ref{fig:del_delres_eres_15}.
 
\begin{figure*}[h]
\begin{center}
\includegraphics[width=0.75\textwidth]{del_delres_eres_15.pdf}
\caption {Resolution of the $\delta$ measurement as a function of energy resolution
\label{fig:del_delres_eres_15}}
\end{center}
\end{figure*}
