...
\section{Study of the experiment resolution}
 ...
 The value of $\sqrt{\chi^2}$ as a function of hypothetical $\delta$ for the true values $\delta = \pi/2, 3\pi/2$ is shown
...
\end{figure*}
 ...
 The resolution of $\delta$ measurement for the true values $\delta = \pi/2, \pi, 3\pi/2$ is shown in Fig. \ref{fig:del_delres_eres}. It is determined
...
\caption {Resolution of the $\delta$ CP measurement as a function of energy resolution for the true values $\delta = \pi/2$ (red),
$\delta = \pi$ (blue), $\delta = 3\pi/2$ (green).
