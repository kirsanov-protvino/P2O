{
  auto c1 = new TCanvas("del_anu10"," ",200,10,900,600);
  c1->SetGrid();

  TGraph* graph_del = new TGraph("del_05_anu10.dat");
  graph_del->SetTitle("");
  ...
  TGraph* graph_del_1 = new TGraph("del_1_anu10.dat");
  graph_del_1->SetLineWidth(3);
  graph_del_1->SetLineColor(kGreen);
  graph_del_1->Draw("C SAME");

  TGraph* graph_del_0 = new TGraph("del_0_anu10.dat");
