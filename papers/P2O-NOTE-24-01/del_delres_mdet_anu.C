{
  ...
  auto c1 = new TCanvas("del_delres_mdet_anu"," ",200,10,900,600);
  c1->SetGrid();

  TGraph* graph_del = new TGraph("del_delres_mdet1_anu.dat");
  ...
  TGraph* graph_del_1 = new TGraph("del_delres_mdet2_anu.dat");
