{
  auto c1 = new TCanvas("del_anu_4"," ",200,10,900,600);
  c1->SetGrid();

  TGraph* graph_del = new TGraph("del_05_anu.dat");
  graph_del->SetTitle("");
  ...
  TGraph* graph_del_15 = new TGraph("del_15_anu.dat");
  graph_del_15->SetLineWidth(3);
  graph_del_15->SetLineColor(kRed);
  graph_del_15->Draw("C SAME");

  TGraph* graph_del_1 = new TGraph("del_1_anu.dat");
