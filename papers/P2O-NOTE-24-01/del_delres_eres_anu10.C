{
  auto c1 = new TCanvas("del_delres_eres_anu10"," ",200,10,900,600);
  c1->SetGrid();

  TGraph* graph_del = new TGraph("del_delres_eres_anu10.dat");
  graph_del->SetTitle("");
  ...
  graph_del->SetMaximum(60.);
  graph_del->Draw("AC");

  TGraph* graph_del_15 = new TGraph("del_delres_eres_15_anu10.dat");
  graph_del_15->SetLineColor(kRed);
  graph_del_15->SetLineWidth(3);
  graph_del_15->Draw("C SAME");

  TGraph* graph_del_1 = new TGraph("del_delres_eres_1_anu10.dat");
  graph_del_1->SetLineColor(kGreen);
  graph_del_1->SetLineWidth(3);
  graph_del_1->Draw("C SAME");

  TGraph* graph_del_0 = new TGraph("del_delres_eres_0_anu10.dat");
