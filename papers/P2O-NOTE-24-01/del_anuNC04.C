{
  auto c1 = new TCanvas("del_anuNC04"," ",200,10,900,600);
  c1->SetGrid();

  TGraph* graph_del = new TGraph("del_05_anuNC04.dat");
  graph_del->SetTitle("");
